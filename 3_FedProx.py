...
#%%
'''Sahu, Anit Kumar et al. “Federated Optimization in Heterogeneous Networks.” 
arXiv: Learning (2018): n. pag..'''
#%%
...
for tt in range(1):
    ...
    for P in [0.1]:  # Ensure correct indentation in the loop body
        ...
        for r in range(rounds):
            ...
            num_clients = max(1, int(P * len(all_clients)))
            ...
            for car_id, ev_data in selected_clients:
                ...
                global_params = {name: param.detach().clone() for name, param in local_model.named_parameters()}
...
# with open('/home/ps/haichao/13_Fedaral_learning/results/fedprox_round.pkl', 'wb') as f:
#     pickle.dump(data_to_save, f)
torch.save(final_model, '/home/ps/haichao/13_Fedaral_learning/trained_models/fedprox_model.pth')